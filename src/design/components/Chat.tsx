...
import QuestionVoiceBox from "./QuestionVoiceBox";
// @ts-ignore
import testVoiceMessage from '../../assets/test-voice.mp3';
import AnswerVoiceBox from "./AnswerVoiceBox";
...
const DesignChat: React.FC<Props> = (props) => {
        ...
        <ul>
          {props.messages.map((message) => (
            <li key={message.id} className="px-4 py-4 sm:px-6">
              <div className="flex items-center justify-between">
                ...
                {message.file && (
                  <div className="flex items-center">
                    <audio controls>
                      <source src={URL.createObjectURL(testVoiceMessage!)} />
              ...
              {/* <QuestionVoiceBox message={message} question={getQuestions(i)}/> */}
              <div className="flex justify-end">
                <AnswerVoiceBox message={message}/>
              </div>
